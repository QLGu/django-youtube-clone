...
urlpatterns = patterns('',
    ...
    url(r'^delete_user/',views.kullanici_sil),
    url(r'^change_pass/',views.sifre_degistir),
    url(r'^update_email/', views.mail_degistir),
    url(r'^add_video/',views.video_ekle),
    url(r'^edit_video/(.+)/',views.video_duzenle),
    url(r'^del_video/(.+)/',views.video_sil),
