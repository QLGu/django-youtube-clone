...
urlpatterns = patterns('',
    ...
    url(r'^/add-multi-list/$',views.coklu_listeye_ekle),
    url(r'^/add-multi-tag/$',views.coklu_tag_ekle),
    url(r'^/change-multi-cat/$',views.coklu_kategori_degistir),
    url(r'^/delete-multi/$',views.coklu_sil),
    url(r'^/make-multi-public/$',views.coklu_public),
    url(r'^/make-multi-owner-public/$',views.coklu_url_public),
    url(r'^/make-multi-private/$',views.coklu_private),
)
